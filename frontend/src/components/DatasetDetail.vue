  ...
  <v-card :loading="loading">
      ...
      {{ item.notes }}
        ...
        <v-list  v-if="item" three-line>
          ...
          <list-item title="Uploader contact" :text="item.email" icon="mdi-at" :link="`mailto:${item.email}`" link-icon="mdi-email-outline" link-tooltip="Send an email to the uploader" external/>
