...
export default new Vuex.Store({
  ...
  modules: {
    ...
    ui,
    api,
    traits: EntityModule('traits', true),
    taxonomy: EntityModule('taxonomy', true),
    locations: EntityModule('locations', true),
    methods: EntityModule('methods', true),
    datasets: EntityModule('datasets', true),
    references: EntityModule('references', true),
