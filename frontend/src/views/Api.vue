<template>
  <v-container>
    ...
    <h2>REST API</h2>
    <p>This page will contain information about the available APIs.</p>
    <p>At the moment, the APIs are not documented. However, you can inspect the API using the browser Developer tools.</p>
    <p>To fully use the API (e.g. view items with restricted access), you have to have an user account.</p>
    <auth-section>
    <p>For programmatic access, you will need to provide a <a href="https://en.wikipedia.org/wiki/Basic_access_authentication" target="_blank">Basic auth in HTTP Authorization header</a> with your login and dedicated API key which you can view here.</p>
